...
public class PersonAPITest {
    ...
    @Given("there are pesons with {int}")
    public void thereArePesonsWith(Integer id) {
    	this.id = id.toString();
    }

    @When("I select person with spesific <Id>")
    public void iSelectPersonWithSpesificId() {
    ...
    @Then("I recive  Oddmund and Korsveien for that id")
    public void iReciveOddmundAndKorsveienForThatId() {
    	
	          response.then()
	             .assertThat()
	   	      .body("firstName", equalTo("Oddmund"))
	   	      .body("familyName", equalTo("Korsveien"));
    }

   
    @Then("I recive  Stein and Korsveien for that id")
    public void iReciveSteinAndKorsveienForThatId() {
    ...
    @Then("The person is created with id {int}")
    public void thePersonIsCreatedWithId(Integer id) {
       this.id = id.toString();
    }

    @Then("The person with id {int} is updated with first name {string} and fammiliy name {string}")
